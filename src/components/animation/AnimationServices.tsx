...
import { Film, Monitor, Laptop, Gamepad2, Box, Sparkles, Brain, VrHeadset } from 'lucide-react';
...
export function AnimationServices() {
  const services = [
    ...
    },
    {
      ...
      description: "Immersive VR experiences with optimized 3D animations and interactive environments."
    },
    {
      icon: Box,
